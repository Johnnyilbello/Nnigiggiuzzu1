...
const MENU_DATA: MenuItem[] = [
  ...
  { 
    ...
    category: 'Secret', 
    secret: true,
    ingredients: "TRIPLO Hamburger 180g (540g tot), Triplo Cheddar, Uovo fritto, Bacon croccante, Anelli di cipolla, Salsa BBQ piccante",
    description: "Solo per chi comanda. Un mostro a tre piani.",
  ...
  { 
    ...
    category: 'Secret', 
    secret: true,
    ingredients: "Doppio Hamburger, Burrata intera 125g, Pesto di pistacchio artigianale, Mortadella piastrata, Granella di pistacchio",
  ...
  { 
    ...
    description: "Frittura dorata e croccante.",
    variants: [
  ...
  { 
    ...
    category: 'Antipasti', 
    popular: true, 
    description: "Porchetta e cheddar fuso.",
    variants: [
  ...
  { 
    ...
    price: 2.00, 
    category: 'Antipasti',
    description: "Bacon croccante e cheddar.",
    variants: [
  ...
  { 
    ...
    price: 3.00, 
    category: 'Antipasti', 
    description: "Salsiccia e fonduta di formaggi.",
    variants: [
  ...
  { 
    ...
    price: 2.50, 
    category: 'Antipasti', 
    ingredients: "Carni miste, prezzemolo, caciocavallo, cipolla, uova, latte, pangrattato" 
  },
  { 
    id: 'a21', 
    ...
    price: 2.50, 
    category: 'Antipasti', 
    ingredients: "Mollica, prosciutto, mozzarella, verdure" 
  },
  { id: 'a22', name: "Speedy Pollo (5pz)", price: 1.50, category: 'Antipasti' },
  { id: 'a23', name: "Anelli di Pollo (5pz)", price: 2.00, category: 'Antipasti', description: "Aromatizzati alla cipolla" },
  { id: 'a24', name: "Panelle", price: 0.50, category: 'Antipasti', tags: ['vegetariano', 'glutenfree'], description: "Prezzo al pezzo" },
  { id: 'a25', name: "Crocché", price: 0.50, category: 'Antipasti', description: "Prezzo al pezzo" },

  // --- PANINI ---
  { id: 'p1', name: "Cartoccio", price: 2.50, category: 'Panini', ingredients: "Prosciutto, mozzarella" },
  { id: 'p2', name: "Hot Dog", price: 2.50, category: 'Panini', ingredients: "Wurstel" },
  ...
  { 
    ...
    price: 3.50, 
    category: 'Panini', 
    description: "Carne a scelta tra: Vitello, Pollo o Pizzaiola",
    tags: ['consigliato']
  },
  ...
  { 
    ...
    price: 5.00, 
    category: 'Panini', 
    ingredients: "Hamburger, cheddar, pancetta fresca",
  ...
  { id: 'p9', name: "Chicken", price: 4.50, category: 'Panini', ingredients: "Hamburger di pollo, funghi, grana" },
  { id: 'p10', name: "Porcellino", price: 3.50, category: 'Panini', ingredients: "Coppietta, cipolla caramellata" },
  ...
  { id: 'p13', name: "Salsicciotto", price: 4.50, category: 'Panini', ingredients: "Salsiccia classica, provola" },
  { id: 'p14', name: "Pizzaiolo", price: 4.50, category: 'Panini', ingredients: "Salsiccia pizzaiola, scamorza affumicata" },
  ...
  { id: 'p17', name: "Panino Panelle", price: 2.00, category: 'Panini', tags: ['vegetariano'] },
  { id: 'p18', name: "Panino Crocché", price: 2.00, category: 'Panini', tags: ['vegetariano'] },
  ...
  // --- PRIMI E SECONDI ---
  { id: 'ps1', name: "Anelletti al forno", price: 4.00, category: 'Primi e Secondi', popular: true, image: "https://images.unsplash.com/photo-1633337668163-5841997159ad?q=80&w=800&auto=format&fit=crop" },
  { id: 'ps2', name: "Pollo allo Spiedo", price: 10.00, category: 'Primi e Secondi' },
  { id: 'ps3', name: "Grigliata Mista", price: 15.00, category: 'Primi e Secondi', ingredients: "Fettina di bovino, salsiccia, fettina di pollo, puntina di suino", popular: true },
  ...
  { id: 'd3', name: "Cassatelle Siciliane", price: 1.50, category: 'Dolci' },
  { id: 'd4', name: "Waffel Nutella", price: 2.50, category: 'Dolci' },
  { id: 'd5', name: "Waffel Pistacchio", price: 3.50, category: 'Dolci' },
  { id: 'd6', name: "Macedonia Frutta", price: 3.00, category: 'Dolci', tags: ['vegetariano', 'glutenfree'] },
  ...
  { id: 'bi10', name: "Messina Sale 33cl", price: 2.50, category: 'Birre', image: "https://images.unsplash.com/photo-1608270586620-248524c67de9?q=80&w=800&auto=format&fit=crop" },
